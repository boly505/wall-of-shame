...
const RULES = [
  {
    icon: '⛓️',
    title: 'المادة الأولى — الملكية المطلقة',
    body: "أقر أنا الديوث بأنني لا أملك أي حق في أهلي أو زوجتي، وأنهم جميعاً ممتلكات شخصية للسيد، يتصرف فيهم كما يشاء، وأنا مجرد خادم لمصالح السيد.",
  },
  {
    icon: '🚫',
    title: 'المادة الثانية — إلغاء الغيرة',
    body: "أقر بأن الغيرة شعور محظور ومرفوض تماماً في هذا المكان، وأن أي ذرة غيرة أشعر بها هي إهانة مباشرة للسيد وخيانة لعهدي، وتستوجب الطرد الفوري من جنة التفرج. ",
  },
  {
    icon: '🗣️',
    title: 'المادة الثالثة - الاعتراف الدائم',
    body: "يلتزم كل ديوث عند كل تعليق يبدأه بلقب 'سيدي'، مع ذكر اعتراف صريح يصف مدى إعجابه وفخره برؤية محارمه تحت سيطرة السيد وتحت قدميه.",
  },
  {
    icon: '🤫',
    title: 'المادة الرابعة — الصمت والمراقبة',
    body: "يمنع منعاً باتاً التعليق بأي رأي شخصي أو نصيحة. دورك هنا هو المشاهدة فقط، والتصفيق لكل ما يفعله السيد، والامتنان للسيد لأنه سمح لك برؤية هذا الانكسار.",
  },
  {
    icon: '🐕',
    title: 'المادة الخامسة — الطاعة العمياء',
    body: "أقر بأن أي أمر يصدره السيد لأي ديوث يجب تنفيذه فوراً دون تردد أو نقاش، وإلا اعتبرت خائناً ومحارمي خارج حمايتي ومباحات للسيد تماماً.",
  },
  {
    icon: '📜',
    title: 'المادة السادسة — التنازل عن الخصوصية',
    body: "بموافقتك على هذا الميثاق، أنت توافق على أن تنشر صور محارمك وتاريخهم وتفاصيل حياتهم تحت تصرف السيد، وأنه لا وجود لأي خصوصية أو حرمة في هذا الموقع أمام رغبات السيد.",
  },
];
